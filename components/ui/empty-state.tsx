...
export function EmptyIdeas() {
  return (
    <EmptyState
      ...
      description="Ajoutez vos premières idées de contenu pour les garder en mémoire."
    />
  );
}

export function EmptyShoots() {
  return (
    <EmptyState
      icon={defaultIcons.shoots}
      title="Aucun tournage planifié"
      description="Planifiez votre prochain tournage pour le voir apparaître ici."
    />
  );
}
...
export function EmptyPipeline() {
  return (
    <EmptyState
      ...
      title="Pipeline vide"
      description="Ajoutez des tâches de tournage, montage ou publication."
    />
  );
}
...
export function EmptyAds() {
  return (
    <EmptyState
      icon={defaultIcons.ads}
      title="Aucune campagne publicitaire"
      description="Connectez vos comptes Ads pour voir vos campagnes ici."
    />
  );
}
...
export function EmptyData() {
  return (
    <EmptyState
      ...
      description="Les données apparaîtront une fois la synchronisation effectuée."
    />
  );
}
